...
import com.example.thermalprinter.app.IHApplication;
import com.example.thermalprinter.model.PrintViewPrescription;
import com.example.thermalprinter.utils.BaseEnum;
import com.example.thermalprinter.utils.BluetoothDeviceChooseDialog;
...
public class TextPrintESCActivity extends AppCompatActivity /*extends BaseActivity*/ implements View.OnClickListener,
    ...
    private static int GROUP_PERMISSION_REQUEST = 1000;
    ...
    public void init() {
        ...
        IHApplication.getInstance().setCurrentCmdType(BaseEnum.CMD_ESC);
        ...
        IHApplication.getInstance().setRtPrinter(rtPrinter);
        rtPrinter = IHApplication.getInstance().getRtPrinter();
...
//        showImage(uri);
    ...
    private void textPrint() throws UnsupportedEncodingException {
        ...
        switch (IHApplication.getInstance().getCurrentCmdType()) {
            ...
            public void run() {
                if (rtPrinter != null) {
                    ...
                    if (rtPrinter.getPrinterInterface() != null) {
                        ...
                        IHApplication.setAlertDialogCustomTheme(TextPrintESCActivity.this, alertDialog);
                    } else {
        ...
        bluetoothDeviceChooseDialog.setOnDeviceItemClickListener(
                new BluetoothDeviceChooseDialog.OnDeviceItemClickListener() {
                    ...
                    public void onDeviceItemClick(BluetoothDevice device) {
                        if (ActivityCompat.checkSelfPermission(TextPrintESCActivity.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
...
//                                    Toast.LENGTH_SHORT).show();
    ...
    private boolean checkAndRequestPermissions() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            int bluetoothScanPermission =
                    ContextCompat.checkSelfPermission(this, Manifest.permission.BLUETOOTH_SCAN);
            int bluetoothConnectPermission =
